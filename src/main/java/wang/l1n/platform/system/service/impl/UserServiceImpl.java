...
import wang.l1n.platform.system.dao.UserRoleMapper;
...
import wang.l1n.platform.system.service.UserRoleService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public IPage<User> findUserDetail(User user, QueryRequest request) {
        try {
            ...
            SortUtil.handlePageSort(request, page, "userId", ForestConstant.ORDER_ASC, false);
